...
<html lang="en">
<head>
  <title>Automobile Worskshops</title>
  <script>
...
<body style="background-color: lightpink;">      
    ...
    <?php
        include 'connect.php';       
        $query="SELECT * FROM workshops WHERE organisation='AUTO' or organisation='auto' ORDER BY date ASC";
        $result=mysqli_query($conn,$query);
        ?> <div class='container'><?php
        while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){ ?>
          <div class='work_c'>
            <div class='header'>    
            <h1 style="color:white"><img src="auto.jpeg" class="img"/>&nbsp&nbsp<?=$row['title']?></h1> 
            </div>
            <div class='content'>
